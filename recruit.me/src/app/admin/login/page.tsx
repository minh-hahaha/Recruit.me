...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch("https://8f542md451.execute-api.us-east-1.amazonaws.com/prod/admin/login", {
                method: "POST",
            ...
            if (!res.ok) {
                ...
                router.push(`/admin/profile?aid=${encodeURIComponent(data.id)}`);
    ...
    return (
        <main className="flex w-full max-w-3xl flex-col items-center justify-center px-6 py-24 sm:px-16 sm:py-32">
            <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow-lg p-8 border border-zinc-100 dark:border-zinc-800">
                <h1 className="text-3xl font-semibold mb-6 text-black dark:text-zinc-50 text-center">Admin Login</h1>
