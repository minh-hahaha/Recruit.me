        ...
        <div>
            <div className="flex flex-col font-sans">
                <main className="flex-grow flex flex-col justify-center px-6 py-24 sm:px-16 sm:py-12">
                    ...
                    {/* Admin */}
                    <div className="mt-8 group flex-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-200 p-8 flex flex-col items-center max-w-sm mx-auto">
                        <h2 className="text-2xl font-semibold mb-6 text-zinc-900 dark:text-zinc-50">
                            Admin
                        </h2>
                        <p className="text-zinc-600 dark:text-zinc-400 mb-6 text-center">
                            Administrative tasks like creating reports and management
                        </p>
                        <div className="flex flex-col gap-4 w-full">
